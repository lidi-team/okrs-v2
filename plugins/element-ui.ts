...
Vue.component(
  elComponent.ElRow,
  () =>
    import(/* webpackChunkName: 'element-ui-form-row' */ 'element-ui/lib/row'),
);
Vue.component(
  elComponent.ElCol,
  () =>
    import(/* webpackChunkName: 'element-ui-form-col' */ 'element-ui/lib/col'),
);
Vue.component(
...
Vue.component(
  elComponent.ElTag,
  () => import(/* webpackChunkName: 'element-tag' */ 'element-ui/lib/tag'),
);
Vue.component(
  elComponent.ElDrawer,
  () =>
    import(/* webpackChunkName: 'element--drawer' */ 'element-ui/lib/drawer'),
);
Vue.component(
  elComponent.ElSlider,
  () =>
    import(/* webpackChunkName: 'element-ui-slider' */ 'element-ui/lib/slider'),
);
Vue.component(
