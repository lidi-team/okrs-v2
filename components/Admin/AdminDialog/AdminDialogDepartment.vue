<template>
  ...
  >
    <el-row>
      <el-col :span="24">
        <el-form
          ref="tempCreateDepartment"
          :model="tempCreateDepartment"
          :rules="rules"
        >
          <el-form-item
            label="Tên phòng ban"
          ...
          >
            <el-input
              v-model="tempCreateDepartment.name"
              placeholder="Nhập tên phòng ban"
            />
          </el-form-item>
          <el-form-item label="Mô tả" prop="description" label-width="120px">
            <el-input
              v-model="tempCreateDepartment.description"
              type="textarea"
...
export default class TeamDialog extends Vue {
  ...
  private createTeam() {
    this.loading = true;
    (this.$refs.tempCreateDepartment as Form).validate(
